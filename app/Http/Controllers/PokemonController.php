...
{     
    ...
    {
        Gate::authorize(ability:'create', arguments: Pokemon::class);
    ...
    {
        Gate::authorize(ability:'update', arguments: Pokemon::class);
    ...
    {
        Gate::authorize(ability:'delete', arguments: Pokemon::class);
